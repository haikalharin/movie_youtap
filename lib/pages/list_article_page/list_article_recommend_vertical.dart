...
class ListArticleRecommendVertical extends StatefulWidget {
  ...
  @override
  State<ListArticleRecommendVertical> createState() =>
      _ListArticleRecommendVerticalState();
}

class _ListArticleRecommendVerticalState
    extends State<ListArticleRecommendVertical> {
                                                ...
                                                if (!state.isLast) {
                                                  if (widget.isSearch == true) {
                                                    Injector.resolve<
                                                            ArticlePageBloc>()
                                                        .add(
                                                            ReadRecommendationsMovieArticle(
        ...
        itemBuilder: (context, index) {
          ...
          outputDate = outputFormat.format(DateTime.parse(
              state.listArticle![index].releaseDate != null &&
                      state.listArticle![index].releaseDate != ''
